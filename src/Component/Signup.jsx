...
function Signup() {
  ...
  const handelSumbit=async(e)=>{
    ...
    const response = await fetch("http://localhost:8000/signup",{method:"POST",
      headers: {
  ...
  <div className="min-h-screen p-6 bg-gray-100 flex items-center justify-center" onSubmit={handelSumbit}>
            ...
            value={FormData.Soda}
                ...
                <div className="md:col-span-5 text-right">
                  <div className="inline-flex items-end">
                    <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onSubmit={handelSumbit}>
                      Submit
                    </button>
                  </div>
                </div>
